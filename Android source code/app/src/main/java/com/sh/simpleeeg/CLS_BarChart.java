...
public class CLS_BarChart
{
                            ...
                            int _iLine1Color, int _iLine2Color, float _fScale)
    {
        ...
        m_XYMultipleSeriesRenderer.setMargins(new int[] {
                (int)(30*clsData.fLineChartTextScale()), (int)(60*clsData.fLineChartTextScale()),
                (int)(60*clsData.fLineChartTextScale()), (int)(30*clsData.fLineChartTextScale()) });//上,左,下,右
        ...
        if(bShowGrid)
            m_XYMultipleSeriesRenderer.setLabelsTextSize(_fScale*30f*clsData.fLineChartTextScale());// 設定XY軸顯示數字的文字大小
        else
            m_XYMultipleSeriesRenderer.setLabelsTextSize(0f);// 設定XY軸顯示數字的文字大小

        m_XYMultipleSeriesRenderer.setLegendTextSize(_fScale*40f*clsData.fLineChartTextScale());//左下方線條文字名稱大小
