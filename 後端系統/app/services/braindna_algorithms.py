...
_PROP_RANGE = {
    ...
    "r_lbeta":  (0.015, 0.045),  # 實測 1.9%~4.4%，mean 3.3%
    "r_hbeta":  (0.025, 0.070),  # 實測 3.1%~6.5%，mean 4.6%（原 0.035 上限過低）
    "r_lgamma": (0.020, 0.050),  # 實測 2.5%~4.6%，mean 3.4%（原 0.025 上限過低）
    "r_hgamma": (0.012, 0.032),  # 實測 1.5%~3.0%，mean 2.1%（原 0.020 上限過低）
}
